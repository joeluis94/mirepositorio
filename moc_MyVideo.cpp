...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MyVideo_t, stringdata) + ofs \
...
void MyVideo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->pasefoto((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyVideo::*_t)(QImage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyVideo::pasefoto)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject MyVideo::staticMetaObject = {
    { &QAbstractVideoSurface::staticMetaObject, qt_meta_stringdata_MyVideo.data,
      qt_meta_data_MyVideo,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyVideo.stringdata))
...
// SIGNAL 0
void MyVideo::pasefoto(QImage _t1)
{
